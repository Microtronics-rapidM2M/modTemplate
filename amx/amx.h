...
#define TAGMASK     (~(PUBLICTAG|FIXEDTAG))
...
SVCALL(SVC_AMX_RAISEERROR, int AMXAPI, amx_RaiseError(AMX *amx, int error));
SVCALL(SVC_AMX_REGISTER, int AMXAPI, amx_Register(AMX *amx, const AMX_NATIVE_INFO *nativelist, int number));
